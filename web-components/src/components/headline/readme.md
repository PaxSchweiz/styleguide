...
Headline is a wrapper element for headlines from level 1 to 6.
...
<pax-headline>Pax Headline</pax-headline>
...
| -------- | --------- | ----------------------------------------- | -------- | ------- |
| `level`  | `level`   | The headline level of the native element. | `number` | `2`     |
